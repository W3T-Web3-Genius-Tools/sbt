...
contract LifeOfSea is ERC721A {
    ...
    constructor(string memory _baseURI, string memory _contractMetadata) ERC721A("Life of Sea", "Sea") {
         owner = msg.sender;
        baseURI = _baseURI;
    ...
    function setContractURI(string memory _contractMetadata) external onlyOwner{
        contractMetadata = _contractMetadata;
    }
